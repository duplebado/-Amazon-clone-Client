<template>
  <div>
    <header class="nav-opt-sprite nav-locate-us nav-long-en nav-ssl nav-unrec">
      <div class="container-fluid desktop-nav">
        ...
        <div class="row">
          <!-- Delivery -->
          <!-- <template v-if="$auth.$state.user.address.city">
            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 pt-2">
          ...
          <!-- Shopping -->
          <div class="col-xl-6 col-lg-5 col-md-4 col-sm-6 pt-0">
            <div class="nav-fill">
              <div class="nav-shop">
                <nuxt-link
                  to="/history"
          ...
          <div class="col-xl-4 col-lg-5 col-md-6 col-sm-4 pt-0">
            <div class="nav-tools">
              <a
                href="#"
                id="icp-nav-flyout"
